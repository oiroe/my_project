...
SRCS = ft_isalnum.c ft_itoa.c ft_memset.c ft_strchr.c ft_strlcpy.c ft_strrchr.c	ft_tolower.c \
...
ft_bzero.c   ft_isdigit.c  ft_memcpy.c   ft_putnbr_fd.c   ft_strjoin.c   ft_strncmp.c	ft_toupper.c \
